...
En el trab\'ajo pr\'actico anterior se vio la importancia de la detecci\'on de bordes como herramienta utilizada en el procesamiento de imágenes, y se desarrollaron algoritmos capaces de aplicar los filtros m\'as comunes en esta \'area (Sobel, Roberts y Prewitt)
